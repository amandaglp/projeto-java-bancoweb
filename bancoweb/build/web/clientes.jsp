                    ...
                    <tbody>
                        ...
                        <c:forEach var="cliente" items="${clientes}">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center"><a href='editar?id=<c:out value="${cliente.id}"/>' onclick="return confirm('Deseja mesmo editar esse usuário?')">&#128394</a></td>
                                <td style="text-align: center"><a href='excluir?id=<c:out value="${cliente.id}"/>' onclick="return confirm('Confirma a exclusão do REGISTRO?')">&#128465</a></td>
                            </tr>
